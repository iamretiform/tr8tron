...
function draw() {
  background(systems.length + 100, systems.length, 0);
  background(systems.length*Math.random()*100,systems.length*Math.random()*100, systems.length*Math.random()*100);
...
CrazyParticle.prototype.display=function() {
  ...
  translate(this.position.y, this.velocity.x)
  translate(this.position.y, this.position.x)
  rotate(this.theta);
  rotate(this.theta*this.theta);
  stroke(this.position.x,this.lifespan);
  color(255,this.lifespan,0)
  line(0,0,25,0);
  pop();
}
